...
<script>
import HeaderPanel from "../Menu/MenuPanel.vue";
import AsidePanel from "../Aside/AsidePanel.vue";
import UploadModal from "../Modal/Upload/UploadModal.vue";
import ScaleModal from "../Modal/Scale/ScaleModal.vue";
import PippetModal from "../Modal/Pippet/PippetModal.vue";
import CurvesModal from "../Modal/Curves/CurvesModal.vue";
import FilteringModal from "../Modal/Filter/FilteringModal.vue";
export default {
  name: "CanvasArea",
  components: {
    AsidePanel,
